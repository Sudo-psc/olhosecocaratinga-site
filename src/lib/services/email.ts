...
export function generateClinicNotificationEmail(data: {
  ...
  const subject = `🆕 Novo Contato - ${data.nome} | Olho Seco Caratinga`;
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #003D7A 0%, #0f172a 100%); padding: 30px; border-radius: 16px 16px 0 0;">
    ...
    <p style="color: #94a3b8; margin: 10px 0 0 0; font-size: 14px;">Olho Seco Caratinga</p>
  </div>
  ...
  <div style="background: #f8fafc; padding: 30px; border: 1px solid #e2e8f0; border-top: none;">
    ...
    <div style="margin-top: 20px; text-align: center;">
      <a href="https://wa.me/55${data.telefone.replace(/\D/g, "")}?text=${encodeURIComponent(`Olá ${data.nome}! Recebemos sua mensagem pelo site Olho Seco Caratinga. Como posso ajudar?`)}"
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #003D7A 0%, #0f172a 100%); padding: 30px; border-radius: 16px 16px 0 0; text-align: center;">
    <img src="https://olhosecocaratinga.com.br/logo_prata.jpeg" alt="Saraiva Vision" style="height: 60px; margin-bottom: 15px;">
